...
const FILTERS: [string, string, string][] = [["all", "All", "Tous"], ["awaiting", "Awaiting", "En attente"], ["hub", "At hub", "Au point relais"], ["transit", "In transit", "En transit"], ["delivered", "Delivered", "Livrés"], ["issues", "Issues", "Problèmes"]];
