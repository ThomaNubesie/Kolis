...
export function emailReason(v: EmailVerdict, fr: boolean): string {
  ...
  if (v.reason === "undeliverable") return fr ? "Cette adresse courriel n'existe pas ou ne peut pas recevoir de courriel." : "That email address doesn't exist or can't receive mail.";
