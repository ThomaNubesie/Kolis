-- Driver matching for the LoadQ-integrated parcel flow.
alter table public.kolis_parcels add column if not exists to_region text;

-- PII-free list of available zone parcels matching the calling driver's queue.
...
-- Driver accepts an available parcel that matches their current queue.
